...
template <typename T, template <typename, typename> class Cont = vector>
class Heap {
public:
...
template <typename T, template <typename, typename> class Cont, typename Out>
